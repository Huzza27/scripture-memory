                ...
                >
                  <TouchableOpacity onPress={toggleDailyMenu}>
                    <View className="flex-row items-center gap-1.5 h-7">
                      ...
                      <Text
                        className="text-m font-bold uppercase inline-block"
                        ...
                        {dailyVersesMenu && (
                      <TouchableOpacity className="mx-2 rounded pb-0.5" style={{ backgroundColor: theme.green}}>
                        <Text className="px-1.5" style={{ color: theme.text, letterSpacing: 0.6 }}>
                          Practice All!
                        </Text>
                        </TouchableOpacity>
                      )}
