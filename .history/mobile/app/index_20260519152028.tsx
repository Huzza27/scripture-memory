              ...
              <View>
               ...
               <View
                ...
                >
                  ...
                  <Animated.View style={{ overflow: "hidden", maxHeight: 1000, borderBottomLeftRadius: 8, borderBottomRightRadius: 8 }}>
                    <View style={{ backgroundColor: theme.surface }}>
                      <View className="mt-1 mb-2 px-1.5">
                          <TouchableOpacity>
                            <View className="w-full h-6" style={{backgroundColor: theme.green}}>
