...
export default function Index() {
  ...
  //Collapsable Menus
  const [dailyVersesMenuVisible, setDailyVersesMenuVisible] = useState(false)
            ...
            (folders.length > 0 || todayVerses.length > 0) ? (
              <View>
                ...
                {todayVerses.length > 0 && (
                  <View className="">
                  <TouchableOpacity>
                    <View className="flex-row items-center gap-1.5 mb-2.5 rounded-lg h-7" style={{backgroundColor: theme.surface}}>
                    ...
                    {todayVerses.map(v => (
                      <TouchableOpacity
                        key={v.id}
                        className="flex-row items-center justify-between rounded-xl p-3.5 mb-2 border"
