            ...
            (folders.length > 0 || todayVerses.length > 0) ? (
              <View>
                ...
                {todayVerses.length > 0 && (
                  <View className={`overflow-hidden ${dailyVersesMenu ? "rounded-t-lg" : "rounded-none"}`}>
                  <TouchableOpacity onPress={toggleDailyMenu}>
                    <View className="flex-row items-center gap-1.5 h-7" style={{ backgroundColor: theme.surface }}>
                    ...
                    <View style={{ backgroundColor: theme.accent }}>
                      <View className="mt-1 mb-2">
                        {todayVerses.map(v => (
                          <TouchableOpacity
                            key={v.id}
                            className="flex-row items-center justify-between px-3.5 mb-0.5 mt-1"
